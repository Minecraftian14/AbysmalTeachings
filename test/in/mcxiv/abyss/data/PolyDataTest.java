...
class PolyDataTest {
    ...
    @Test
    void testSum() {
        PolyData m1 = new Array1DPolyData(4, 3);
        AtomicInteger integer = new AtomicInteger();
        m1.fill(integer::getAndIncrement);
        PolyData m2 = new Array1DPolyData(1);
        PolyData.sum(m1, 0, m2);
        Assertions.assertArrayEquals(new float[]{18.0f, 22.0f, 26.0f}, m2.export());
        PolyData.sum(m1, 1, m2);
        Assertions.assertArrayEquals(new float[]{3.0f, 12.0f, 21.0f, 30.0f}, m2.export());
    }
