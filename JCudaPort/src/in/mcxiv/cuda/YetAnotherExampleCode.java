...
public class YetAnotherExampleCode {
...
//        String ptxFileName = JCudaSamplesUtils.preparePtxFile("JCudaPort/res/JCudaVectorAddKernel.cu");
        String ptxFileName = JCudaSamplesUtils.preparePtxFileFromCode(SOMETHING);
